 ...
 */
public class TrelloImplImproved implements TrelloImproved {
    ...
    public TrelloImplImproved(String apiKey) {
        this(apiKey, null);
    }

    public TrelloImplImproved(String apiKey, String token) {
        this.apiKey = apiKey;
        this.token = token;
    ...
    @Override
    public void updateCardDescriptor(CardDescriptor cardDescriptor) {
        Card card = cardDescriptor.getCard();
        Map<String, String> keyValueMap = new HashMap<String, String>();
        final String url = TrelloURL
                .create(apiKey, TrelloURL.CARD_URL, card.getId())
                .token(token)
                .build();

        keyValueMap.put("name", card.getName());
    ...
    private InputStream doRequest(String url, String requestMethod, Map<String, String> map) {
        try {
            ...
            if(map != null && !map.isEmpty()) {
                ...
                Log.d("debug", "Request: " + url + "?" + sb.toString());
